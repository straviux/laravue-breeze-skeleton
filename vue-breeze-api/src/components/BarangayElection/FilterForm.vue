...
const positions = ["PUNONG BARANGAY", "BARANGAY KAGAWAD"];
...
function toggleMunicipality() {
    ...
    if (model.value.report_level == "barangay") {
        bskResult.getBarangay(model.value.municipalities);
    }
}
        ...
        <form @submit.prevent="">
            ...
            >
                ...
                <div
                    ...
                    "
                    class="mx-auto btn bg-transparent btn-sm btn-block text-gray-800 m-1 hover:bg-transparent border-0 text-[10px]"
                >
                    {{
                ...
                <button
                    ...
                    :class="
                        ...
                        !model.positions.length
                            ...
                            : ''
                    "
                    @click="bskResult.generateResult(model)"
                >
                    Generate
                </button>
            </div>
