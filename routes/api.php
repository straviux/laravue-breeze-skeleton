...
use App\Http\Controllers\Api\V1\BskController;
...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::apiResource('bskresult', BskController::class);
    Route::get('/bsk-barangay-by-municipality', [BskController::class, 'getBarangayByMunicipality']);
